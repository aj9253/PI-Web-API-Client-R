piElementTemplate <- function(webId = NULL, id = NULL, name = NULL, description = NULL, path = NULL, allowElementToExtend = NULL, baseTemplate = NULL, instanceType = NULL, namingPattern = NULL, categoryNames = NULL, extendedProperties = NULL, severity = NULL, canBeAcknowledged = NULL, links = NULL) {
